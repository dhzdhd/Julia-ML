...
# ╔═╡ 9f0161a0-f3ed-11ed-0417-7de5c7dc60e6
begin
	using Plots
	using DataFrames
	using MLJ
...
# ╔═╡ 819e47b2-43d3-4ccd-9be2-b7e83bad7558
df = dataset("datasets", "iris")

# ╔═╡ 12b2fe84-cb8f-4f1d-961b-f40979eaf675
begin
	y = df.Species
	X = select(df, 1:4)
end

# ╔═╡ 39c9b182-4e42-45ec-82eb-9d73d954f005
scatter(df.PetalLength, df.PetalWidth)

# ╔═╡ a6458585-9fc5-4c95-9f15-93ee9bf54895
begin
	costs = []
	for i = 1:10
		Matrix
...
# ╔═╡ fe72bbbe-ac18-47d7-a29d-9463f126a969
costs

# ╔═╡ d3c1c2ba-29cc-4635-9f95-45ec47b917b2
plot(1:10, costs)

# ╔═╡ 6c2502a6-927c-40bf-90b0-4bc0d9d4a447
model = kmeans(collect(Matrix(X)'), 3, display=:iter)

# ╔═╡ 4e582334-97b2-4a19-80a8-9da48bf4c086
scatter(df.PetalLength, df.PetalWidth, marker_z=model.assignments,
	color=:lightrainbow, legend=false)

# ╔═╡ e36e3578-7a28-4c15-8e18-f2a09857ffe3
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "350f9485e9940ae25e89a82ea6770585e91a41cc"
